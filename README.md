...
This means I now learn only one remote control. A top tip for getting round the TV foreign language suggstions is to turn the set on and **then** plug in the USB. If it's recognized you should get something 
