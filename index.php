...
function get_codecs($fileinfo)
{
    ...
    $codecs['ext'] =  strtolower(pathinfo($fileinfo->getPathname(), PATHINFO_EXTENSION));. PHP_EOL;    
    $codecs['video'] =  ($video_codec[0][0]) . PHP_EOL;
    $codecs['audio'] = ($audio_codec[0][0]) . PHP_EOL;
    return $codecs;
}
